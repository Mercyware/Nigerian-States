...
use Closure;
use Mercyware\States\Exception\StatesExceptions;
...
class StatesLoader
{
    ...
    public static function state($name)
    {
        ...
        if (!isset(static::$states[$name])) {
            static::$states[$name] = json_decode(static::getFile(__DIR__ . '/../resources/states/' . $name . '.json'), true);
        }
    ...
    public static function states()
    {
        ...
        static::$states = json_decode(static::getFile(__DIR__ . '/../resources/states/stateslist.json'), true);
    ...
    public static function where($key, $operator, $value = null)
    {
        ...
        if (! isset(static::$states['longlist'])) {
            static::$states['longlist'] = json_decode(static::getFile(__DIR__.'/../resources/states/stateslist.json'), true);
        }
    ...
    protected static function getFile($filePath)
    {
        if (!file_exists($filePath)) {
            throw StatesExceptions::unknownStateInformationException();
        }
